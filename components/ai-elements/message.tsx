...
export const MessageResponse = memo(
  ({ className, children, ...props }: MessageResponseProps) => (
    <div
      className={cn('size-full whitespace-pre-wrap break-words text-sm [&>*:first-child]:mt-0 [&>*:last-child]:mb-0', className)}
      {...props}
    >
      {children}
    </div>
  ...
  return (
    <div className={cn('group relative size-24 overflow-hidden rounded-lg', className)} {...props}>
      {isImage ? (
        ...
        <>
          <div className="bg-muted text-muted-foreground flex size-full shrink-0 items-center justify-center rounded-lg" title={attachmentLabel}>
